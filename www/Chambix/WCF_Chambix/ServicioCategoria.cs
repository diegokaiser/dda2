    ...
    public class ServicioCategoria : IServicioCategoria
    {
        ...
        public Boolean InsertCategoria(CategoriaBE objcategoriaBE)
        {
            ...
            try
            {
                ...
                objCategoria.create_at = Convert.ToDateTime(objcategoriaBE.create_at);
                objCategoria.create_by = String.Empty;
                objCategoria.update_at = null;
                objCategoria.update_by = String.Empty;
        ...
        public Boolean UpdateCategoria(CategoriaBE objcategoriaBE)
        {
            ...
            try
            {
                ...
                objCategoria.nombreCategoria = objcategoriaBE.nombreCategoria;
                objCategoria.create_at = Convert.ToDateTime(objcategoriaBE.create_at);
                objCategoria.create_by = objCategoria.create_by;
                objCategoria.update_at = Convert.ToDateTime(objcategoriaBE.update_at);
                objCategoria.update_by = objcategoriaBE.update_by;
                Chambix.SaveChanges();
                return true;
            }
            catch (EntityException ex)
