    ...
    public class ServicioServicio : IServicioServicio
    {
        public Boolean InsertServicio(ServicioBE objServicioBE)
        {
            ...
            try
            {
                ...
                objServicio.estadoServicio = Convert.ToBoolean(1);
                objServicio.create_at = objServicioBE.create_at;
                objServicio.create_by = String.Empty;
                objServicio.update_at = null;
                objServicio.update_by = String.Empty;
        ...
        public Boolean UpdateServicio(ServicioBE objServicioBE)
        {
            ...
            try
            {
                ...
                objServicio.create_at = objServicio.create_at;
                objServicio.create_by = objServicio.create_by;
                objServicio.update_at = null;
                objServicio.update_by = String.Empty;
